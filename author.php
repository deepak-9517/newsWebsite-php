...
global $con;
$aid=$_REQUEST['aid'];
$sql="select * from post left join category on post.p_category=category.category_id left join users on post.p_author=users.u_id where post.p_author=$aid order by post.p_id";
                                ...
                                <div class="inner-content clearfix">
                                    ...
                                    <div class="post-information">
                                        ...
                                        <span>
                                            ...
                                            <a href='author.php'><?=$data['u_user']?></a>
                                        </span>
                                        <span>
